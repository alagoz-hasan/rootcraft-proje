...
public class GridManager : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (left)
        {
            ...
            ScaleGridXLeft(scaleFactor, position, a);
        }
        if (right)
        {
            right = false;
            ...
            Vector3 position = new Vector3(-1f, 0f, 0f);
            Vector3 a = new Vector3(0.4f, 0f, 0f);
            ScaleGridXRight(scaleFactor, position, a);
        }
    }
    ...
    public void ScaleGridXRight(Vector3 scaleFactor, Vector3 position, Vector3 pos)
    {
        for (int i = 0; i < circles.Count; i++)
        {
            for (int j = 0; j < circles[0].Count; j++)
    ...
    public void ScaleGridXLeft(Vector3 scaleFactor, Vector3 position, Vector3 pos)
    {
        for (int i = 0; i < circles.Count; i++)
        {
            for (int j = 0; j < circles[0].Count; j++)
